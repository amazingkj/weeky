        ...
        <>
              ...
              <tbody className="divide-y divide-neutral-100">
                {submissions.map((m) => (
                  <tr key={m.id}
                    ...
                    className={`transition-colors ${m.submission ? 'cursor-pointer hover:bg-neutral-50' : ''} ${selectedMemberId === m.id ? 'bg-neutral-100' : ''}`}>
          ...
          {editedReport && !reportLoading && (
            <div className={fullscreen
              ...
              : 'bg-neutral-50 p-4 rounded-xl border border-neutral-200'
            }>
